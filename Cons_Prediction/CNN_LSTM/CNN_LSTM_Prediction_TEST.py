...
# Model/config paths — '_test' suffix avoids overwriting the main model
MODEL_PATH  = os.path.join(SCRIPT_DIR, 'Model', f'CNN_LSTM_Model_{OUTPUT_HOURS}h_test.keras')
CONFIG_PATH = os.path.join(SCRIPT_DIR, 'Model', f'CNN_LSTM_Config_{OUTPUT_HOURS}h_test.npz')
...
def run_forecast(predict_date: str, hours: int = OUTPUT_HOURS,
    ...
    _mod.MODEL_PATH  = os.path.join(SCRIPT_DIR, 'Model', f'CNN_LSTM_Model_{hours}h_test.keras')
    _mod.CONFIG_PATH = os.path.join(SCRIPT_DIR, 'Model', f'CNN_LSTM_Config_{hours}h_test.npz')
...
""")
    ...
    if args.hours != OUTPUT_HOURS:
        ...
        _mod.MODEL_PATH  = os.path.join(SCRIPT_DIR, 'Model', f'CNN_LSTM_Model_{args.hours}h_test.keras')
        _mod.CONFIG_PATH = os.path.join(SCRIPT_DIR, 'Model', f'CNN_LSTM_Config_{args.hours}h_test.npz')
